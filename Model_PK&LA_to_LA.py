# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 02:49:59 2020
...
dataPath = 'E:\MLData\groundMotion'
file = 'SCEDC_wave4.hdf5'
...
ax3.set_ylim([-2, 2])
plt.tight_layout()
plt.savefig(os.path.join(figSavePath, 'la2la.png'), dpi=200)
plt.savefig(os.path.join(figSavePath, 'la2la.eps'), dpi=200)

figSavePath = 'H:/python/CNN_figure'
np.savetxt(os.path.join(figSavePath, 'la2la.txt'), res)


###########
pred_y2 = m.predict(test_X) #PK
res2 = [] 
for n in range(len(test_Y)):
...
ax3.set_ylim([-2, 2])
plt.tight_layout()
plt.savefig(os.path.join(figSavePath, 'pk2la.png'), dpi=200)
plt.savefig(os.path.join(figSavePath, 'pk2la.eps'), dpi=200)

figSavePath = 'H:/python/CNN_figure'
np.savetxt(os.path.join(figSavePath, 'pk2la.txt'), res2)
...
ax3.set_ylim([-4, 4])
plt.tight_layout()
plt.savefig(os.path.join(figSavePath, 'la_atten.png'), dpi=200)
plt.savefig(os.path.join(figSavePath, 'la_atten.eps'), dpi=200)

figSavePath = 'H:/python/CNN_figure'
np.savetxt(os.path.join(figSavePath, 'la_atten.txt'), res3)
